        ...
        if (dataReceived) {
            ...
            foreach (Body body in this.bodies) {
                if (body.IsTracked) {
                    ...
                    IDictionary<String, Object> jsJoints3d = new Dictionary<String, Object>();
                    ...
                    foreach (JointType jointType in joints.Keys) {
                        ...
                        var ori = new{
                            x = JointOrientations[jointType].Orientation.X,
                            y = JointOrientations[jointType].Orientation.Y,
                            z = JointOrientations[jointType].Orientation.Z,
                            w = JointOrientations[jointType].Orientation.W
                        };
                        jsJoints3d[jointType.ToString()] = new {
                            position = pos,
                            orientation = ori
                        };
